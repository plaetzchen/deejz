...
@interface SenderViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, SearchCellDelegate,DeezerSessionRequestDelegate,DeezerSessionConnectionDelegate,GesturesInterpreterDelegate,VetoCellDelegate>
...
@property (nonatomic, strong) GesturesInterpreter *gestureInt;
